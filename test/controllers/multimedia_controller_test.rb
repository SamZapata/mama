...
class MultimediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multimedium" do
    assert_difference('Multimedium.count') do
      post multimedia_url, params: { multimedium: { about: @multimedium.about, capture_date: @multimedium.capture_date, name: @multimedium.name, uri_path: @multimedium.uri_path } }
    end
  ...
  test "should update multimedium" do
    patch multimedium_url(@multimedium), params: { multimedium: { about: @multimedium.about, capture_date: @multimedium.capture_date, name: @multimedium.name, uri_path: @multimedium.uri_path } }
